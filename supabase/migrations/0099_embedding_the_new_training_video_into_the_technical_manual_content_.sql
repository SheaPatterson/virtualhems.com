...
<div class="max-w-5xl mx-auto space-y-16 pb-32">
    ...
    <section class="space-y-6">
        <div class="flex items-center space-x-2 text-primary">
            ...
            <h4 class="text-xs font-black uppercase tracking-widest">Multimedia Briefing</h4>
        </div>
        <div class="aspect-video rounded-2xl overflow-hidden bg-black border-4 border-muted shadow-xl">
            <video 
        ...
        <p class="text-xs text-muted-foreground italic text-center">Video Briefing: The New School of Helicopter Training — Generated from professional source intelligence.</p>
    </section>
