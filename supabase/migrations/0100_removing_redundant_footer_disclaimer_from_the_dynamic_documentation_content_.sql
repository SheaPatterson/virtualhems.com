...
<div class="max-w-5xl mx-auto space-y-16 pb-32">
    ...
    <section class="space-y-6 m-0">
        ...
        <div class="aspect-video rounded-2xl overflow-hidden bg-black border-4 border-muted shadow-xl m-0">
            <video 
                src="/The_New_School_of_Helicopter_Training.mp4" 
                controls 
                ...
                <div class="overflow-hidden rounded-xl border m-0">
                    <table class="w-full text-xs m-0">
                        ...
                        <tbody class="divide-y font-mono m-0">
                            ...
                            <tr class="m-0"><td class="p-4 font-bold m-0 m-0 m-0 m-0 m-0">Rotor RPM (NR)</td><td class="p-4 m-0 m-0 m-0 m-0 m-0">97% to 104%</td><td class="p-4 m-0 m-0 m-0 m-0 m-0">Continuous range</td></tr>
                            <tr class="m-0"><td class="p-4 font-bold m-0 m-0 m-0 m-0 m-0 m-0">Slope Operation</td><td class="p-4 m-0 m-0 m-0 m-0 m-0 m-0">Max 14°</td><td class="p-4 m-0 m-0 m-0 m-0 m-0 m-0">Avoid mast moment limits</td></tr>
                            <tr class="m-0"><td class="p-4 font-bold m-0 m-0 m-0 m-0 m-0 m-0 m-0">Fuel Capacity</td><td class="p-4 m-0 m-0 m-0 m-0 m-0 m-0 m-0">565.0 kg</td><td class="p-4 m-0 m-0 m-0 m-0 m-0 m-0 m-0">706 Liters total</td></tr>
                        </tbody>
                    </table>
                </div>
            </section>
                ...
                <div class="overflow-hidden rounded-xl border border-primary/20 m-0">
                    <table class="w-full text-xs m-0">
                        ...
                        <tbody class="divide-y m-0">
                            ...
                            <tr class="m-0"><td class="p-4 font-bold m-0 m-0 m-0 m-0 m-0">ETL</td><td class="p-4 m-0 m-0 m-0 m-0 m-0">Occurs at 16-24 knots. Nose will rise (blowback), requires forward cyclic.</td></tr>
                            <tr class="m-0"><td class="p-4 font-bold m-0 m-0 m-0 m-0 m-0 m-0 m-0">Coning</td><td class="p-4 m-0 m-0 m-0 m-0 m-0 m-0 m-0">Upward shape caused by centrifugal force vs lift. Critical for NR monitoring.</td></tr>
                        </tbody>
                    </table>
                </div>
